                                ...
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate="">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <h5 class="">Distribution Details</h5>
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label"
                                                        for="validationCustom01">Distribution Name
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                            placeholder="Enter a Publication Name.." value="{{$data->record1->distributionName}}" required=""
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label"
                                                        for="validationCustom04">Distribution Address <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <textarea type="text" class="form-control" id=""
                                                            ...
                                                            rows="3" value=""
                                                            disabled>{{$data->record1->distributionAddress}}</textarea>
                                                    </div>
                                                </div>
                                                <!-- <div class="mb-3 row">
