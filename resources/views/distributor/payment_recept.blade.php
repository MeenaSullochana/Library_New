                                                        ...
                                                        <tr>
                                                            <td class="content-block">
                                                                <table class="invoice">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>{{ auth('distributor')->user()->firstName }} {{ auth('distributor')->user()->lastName }}<br>Invoice #{{$data->invoiceNumber}}<br>{{ \Carbon\Carbon::parse($data->created_at)->format('Y-m-d ') }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
