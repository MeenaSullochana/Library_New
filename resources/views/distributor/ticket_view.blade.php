                                    ...
                                    <div class="read-content">
                                        <div class="media pt-3 d-sm-flex d-block justify-content-between">
                                            ...
                                            @if(auth('distributor')->user()->profileImage == Null)
                                                        ...
                                                        @else
                                                        <img class="me-3 rounded" width="70" height="70" alt="image"
                                                          src="{{asset("distributor/images/profile/".auth('publisher')->user()->profileImage)}}"> 
                                                        @endif
                                                <div class="media-body me-2">
                                                <h5 class="text-primary mb-0 mt-1">{{auth('distributor')->user()->firstName}}  {{auth('distributor')->user()->lastName}}</h5>
