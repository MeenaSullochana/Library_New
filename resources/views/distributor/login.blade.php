...
<html lang="en" class="h-100">
   <head>
      ...
      <!-- PAGE TITLE HERE -->
      <title>Government of Tamil Nadu - Book Procurement - Distributor - Login </title>
      <!-- FAVICONS ICON -->
                              ...
                              <div class="card-footer">
                                 <div class=" bottom-footer clearfix m-t10 m-b20 row text-center">
                                    <div class="col-lg-12 text-center">
                                       <span> Copyright © 2024 Directorate of Public Libraries, பொது நூலக இயக்ககம் <a href="#">| Design by Gladindia </a> </span>
                                    </div>
                                 </div>
                              </div>
                           </div>
