                                                    ...
                                                    <div class="stute_new d-flex">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="/distributor/ticket_chat/{{$val->id}}">Chat</a>
                                                                <a class="dropdown-item" href="/distributor/ticket_view/{{$val->id}}">View</a>
                                                                <a class="dropdown-item" href="/distributor/ticketdelete/{{$val->id}}">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
