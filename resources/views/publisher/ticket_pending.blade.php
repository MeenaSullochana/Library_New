                                            ...
                                            <li>
                                                ...
                                                <div class="pe-3">
                                                    ...
                                                    @if(auth('publisher')->user()->profileImage == Null)
                                                        ...
                                                        @else
                                                        <img alt="image" width="50" src="{{asset("publisher/images/profile/".auth('publisher')->user()->profileImage)}}">
                                                    ...
                                                    <h5 class="mb-1 new_com ">{{auth('publisher')->user()->firstName}}  {{auth('publisher')->user()->lastName}} 
                                                        </h5>
                                                        <small class="d-block">{{$val->date}}</small>
                                                        <br>
                                                        <h5 class="mb-1 new_com ">{{$val->subject}}</h5>
                                                        @if($val->status=="1")
                                                        <a href="#" class="btn btn-danger btn-xxs"><i class="fa fa-warning p-1"></i>pending</a>
                                                        @else
                                                        <a href="#" class="btn btn-success btn-xxs"><i class="fa fa-check p-1"></i>Complete</a>
                                                        @endif
                                                    </div>
                                                    <div class="stute_new d-flex">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="/publisher/ticket_chat/{{$val->id}}">Chat</a>
                                                                <a class="dropdown-item" href="/publisher/ticket_view/{{$val->id}}">View</a>
                                                                <a class="dropdown-item" href="/publisher/ticketdelete/{{$val->id}}">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
