                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="contact_numer"
                                    placeholder="Enter Your publication Address" value="{{$data->publisherrecord->publicationAddress}}" readonly>
                            </div>
                            <div class="col-md-6">
       ...
       $(document).on('click','#submit',function(e){
        e.preventDefault(); 
          ...
          $.ajax({
             ...
             url: "/publisher/pubapplyadd",
             success: function(response) {
                console.log(response);
                if(response.success){
                    toastr.success(response.success,{timeout:25000});
                    setTimeout(function() {
                        window.location.href = "/publisher/fair_application_apply";
                     }, 3000); 
                }else{
