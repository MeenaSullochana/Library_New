                                    ...
                                    <div class="read-content">
                                        <div class="media pt-3 d-sm-flex d-block justify-content-between">
                                            <div class="clearfix mb-3 d-flex">
                                                        ...
                                                        @else
                                                        <img class="me-3 rounded" width="70" height="70" alt="image"
                                                          src="{{asset("publisher/images/profile/".auth('publisher')->user()->profileImage)}}"> 
                                                        @endif

                                                
                                                <div class="media-body me-2">
                                                    <h5 class="text-primary mb-0 mt-1">{{auth('publisher')->user()->firstName}}  {{auth('publisher')->user()->lastName}}</h5>
