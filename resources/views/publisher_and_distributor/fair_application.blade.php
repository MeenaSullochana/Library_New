                    ...
                    <div class="card-body">
                        <form class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="user_type" value="{{$data->publisherrecord->usertype}}" name="first_name" placeholder="name" readonly>
                            </div>
                            <p class="fw-bold h5">User Details</p>
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">First Name - முதல் பெயர்<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="first_name"  value="{{$data->publisherrecord->firstName}}" name="first_name"  placeholder="First name" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Last name - கடைசி பெயர்<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="last_name" name="last_name"  value="{{$data->publisherrecord->lastName}}" placeholder="Last name" readonly>
                            </div>
                            <div class="col-6">
                                <label for="inputAddress" class="form-label">Email Id - மின்னஞ்சல் முகவரி<span
                                        class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="email_address" value="{{$data->publisherrecord->email}}" name="email"
                                    placeholder="example@gmail.com" readonly>
                            </div>
                            <div class="col-6">
                                <label for="inputAddress2" class="form-label">Contact Number - தொடர்பு எண்<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="contact_numer" placeholder="" value="{{$data->publisherrecord->mobileNumber}}" readonly>
                            </div>
                            <div class="col-6">
                                <label for="inputAddress2" class="form-label"> Address - முகவரி<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="contact_numer"
                                    placeholder="Enter Your publication Address" value="{{$data->publisherrecord->publicationDistributionAddress}}" readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="pub_state" class=" form-select" name="pub_district" required Disabled>
                                    <option value="selected">{{$data->publisherrecord->District}}</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control " id="pub_city" name="pub_city"
                                    placeholder="Enter your city" value="{{$data->publisherrecord->city}}" required readonly>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="pub_pin_code" name="pub_pin_code" value="{{$data->publisherrecord->postalCode}}" readonly>
                            </div>
                            <hr>
...
உங்களுக்கு எத்தனை இருக்கைகள் வேண்டும்?)</h4>
                ...
                <div class="card-footer text-muted">
                    <input type="submit" id="submit"  data-eventid="{{$data->id}}"  data-id="{{$data->publisherrecord->id}}" class="btn btn-primary">
                </div>
            </div>
        </div>
    </div>
       ...
       $(document).on('click','#submit',function(e){
        e.preventDefault(); 
          ...
          $.ajax({
             ...
             url: "/publisher_and_distributor/pubdistapplyadd",
