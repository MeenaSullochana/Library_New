<?php
    @ob_start();
    include "core/event_list.core.php";
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
														<input type="text" class="form-control" id="validationCustom01" name="event_name"  placeholder="Enter Event name.." required value="<?php echo $eventData['event_name']?>" readonly>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="event_date_time" id="validationCustom02"  placeholder="Your valid email.." value="<?php echo $eventData['event_date_time']?>" readonly>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="location" id="validationCustom03" placeholder="Choose a safe one.." value="<?php echo $eventData['location_detail']?>" readonly>
														<div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea class="form-control h-50" id="validationCustom04" name="description"  rows="5" placeholder="What would you like to see?" readonly>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="contact_name" id="validationCustom06" placeholder="Enter The Name" value="<?php echo $eventData['contact_name']?>" readonly>
														<div class="invalid-feedback">
															Please enter a Name.
														</div>
                                                    </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="contact_number" id="validationCustom08" placeholder="000-000-0000" value="<?php echo $eventData['contact_number']?>" readonly>
														<div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="website"  id="validationCustom07"  placeholder="http://example.com" value="<?php echo $eventData['website']?>" readonly>
														<div class="invalid-feedback">
															Please enter a url.
														</div>
                                                    </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="email" id="validationCustom10" placeholder="name@gmail.com" value="<?php echo $eventData['email']?>" readonly>
														<div class="invalid-feedback">
															Please enter a Email.
														</div>
                                                    </div>
