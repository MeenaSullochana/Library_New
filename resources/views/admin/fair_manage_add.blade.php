            ...
            <div class="container-fluid">
                <div class="card-header flex-wrap bg-white mb-5">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <ol class="breadcrumb py-0 m-0">
                            <li class="breadcrumb-item"><a href="/admin/fair_manage_list">List of Fair Management</a>
                            </li>

                            <li class="breadcrumb-item"><a href="/admin/fair_manage_add">Create Fair Management
                                </a></li>
                        </ol>
                    </ul>
                </div>
                <div class="col-xl-12 col-lg-12">
                    <div class="card profile-card card-bx m-b30">
                        <form class="profile-form" method="POST"  action="/admin/fairmanageadd">
                           @csrf
                            <div class="card-body">
                                <div class="row">
