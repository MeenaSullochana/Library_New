                                                    ...
                                                    <td class="py-3">
                                                        <a href="#">
                                                            ...
                                                            @if($val->profileImage != null)
                                                                ...
                                                                @else
                                                                    <div class="avatar avatar-sm me-2">
                                                                        <div class=""> <img class="rounded-circle img-fluid" src='{{ asset("admin/images/default.png") }}' width="30" alt="">
                                                                        </div>
                                                                    </div>
                                                                @endif
        ...
        $('.toggle-class').change(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        setTimeout(function() {
                            window.location.href = "/admin/member_active"
                        }, 3000);
