...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Inactive Book List</title>
    <!-- FAVICONS ICON -->
    ...
    <label class="form-check-label" for="dataall"></label>
                               ...
                               ->get();
                                            ...
                                            <td class="sorting_1">
                                                ...
                                                <td>
                                                    <span> Publisher cum Gistributor</span>
                                                </td>
                                                @else
                                                <td>
        ...
        $('#example3').on('change', '.toggle-class', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        setTimeout(function() {
                            window.location.href = "/admin/manage_inactive_book_list";
                        }, 3000);
