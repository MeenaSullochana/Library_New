                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Reviewer Batch Create</b> </h3>
                                    ...
                                    <div class="card o-hidden border-0 shadow-lg">
                                        <div class="card-body ">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="slug">Reviewer Batch Name *</label>
          ...
          console.log(formData);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/reviewerbatch_add"
                    }, 3000);
