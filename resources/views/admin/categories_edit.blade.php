...
<body>
    ...
    *************-->
    ...
    $("#submitbutton").on("click", function(e) {
        ...
        // Declare formData after preventing the default form submission
        var formData = {
            id: $(this).data('id'),
            name: $("#name").val(),
            status: $("#status").val()
        ...
        console.log(formData); // Now log the formData
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    // Uncomment the lines below if you want to redirect after success
                    // setTimeout(function() {
