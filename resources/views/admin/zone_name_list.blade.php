                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>List of Zone Name</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="zone_name_add.php">
                                        ...
                                        <table class="table table-responsive-md">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                        ...
                                                        style="width: 215.156px;">Zone Type</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                        colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width: 215.156px;">Zone Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                            ...
                                            <tbody>
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="zone_name_view.php"
                                                                class="btn btn-success shadow btn-xs sharp me-1">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                            <a href="zone_name_edit.php"
