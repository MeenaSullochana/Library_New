                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <!-- <p> <a class="btn btn-primary  btn-sm" href="application_list.php">
                           View Zone Name </a>/<a class="btn btn-primary  btn-sm" href="application_list.php">
                             View All Zone </a></p> -->
                    ...
                    <div class="col-lg-12 card-profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card ">
                                    <div class="admin-user">
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Thirupathur</h4></li>
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Dharmapuri</h4></li>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card ">
                                    ...
                                    <div class="admin-user">
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Thirupathur</h4></li>
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Dharmapuri</h4></li>
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Chennai</h4></li>
                                       <li> <h4 class="text-start"><i class="fa fa-chevron-right" aria-hidden="true"></i> Thiruvaamalai</h4></li>
                                    </div>
                                    </div>
                                </div>
                            </div>
