                            ...
                            <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
                                <div id="empoloyees-tbl3_wrapper" class="dataTables_wrapper no-footer">
                                    <table id="example3" class="table dataTable no-footer" role="grid"
                                        ...
                                        <tbody>
                                                   @php
                                                    $rev = DB::table('reviewer')->where('status','=','1')->where('reviewerType', '=','public')->where('creater','=',auth('reviewer')->user()->id)->get();
                                                    @endphp
                                                    @foreach($rev as $val)
                                                    ...
                                                    <td class="py-3">
                                                        <a href="#">
                                                            ...
                                                            @if($val->profileImage != null)
                                                                ...
                                                                @else
                                                                    <div class="avatar avatar-sm me-2">
                                                                        <div class=""> <img class="rounded-circle img-fluid" src='{{ asset("reviewer/images/default.png") }}' width="30" alt="">
                                                                        </div>
                                                                    </div>
                                                                @endif
